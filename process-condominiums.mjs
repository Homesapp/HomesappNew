...
// Leer el archivo
const data = readFileSync('attached_assets/Pasted-Zona-Condominio-Aldea-Tulum-Aldea-Tulum-Kukulkan-Mistiq-Tulum-La-Veleta-Cacao-Aldea-Zama-Paramar-1759780412601_1759780412602.txt', 'utf8');
...
writeFileSync('condominium-colony-mapping.json', JSON.stringify(mapping, null, 2));
console.log('\n✅ Mapeo guardado en: condominium-colony-mapping.json');
