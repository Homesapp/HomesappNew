...
const translations: Record<Language, Record<string, string>> = {
  es: {
    ...
    "public.map.title": "Explora en el Mapa",
    "public.map.subtitle": "Encuentra propiedades por ubicación en Tulum",
    ...
    "profile.securityDesc": "Gestiona tu contraseña",
    ...
    "profile.passwordRequirements": "La contraseña debe tener al menos 8 caracteres, incluyendo mayusculas, minusculas y numeros",
    ...
    "profile.passwordUpdatedDesc": "Tu contraseña ha sido cambiada exitosamente",
    "profile.passwordError": "No se pudo cambiar la contraseña",
    "profile.passwordMismatch": "Las contraseñas no coinciden",
    "profile.currentPasswordIncorrect": "La contraseña actual es incorrecta",
    ...
    "property.addToCompare": "Añadir a comparación",
    "property.removeFromCompare": "Quitar de comparación",
    "property.maxCompareReached": "Máximo alcanzado",
    "property.maxCompareDescription": "Solo puedes comparar hasta 4 propiedades",
    ...
    // SELLER HELP CONTENT (Spanish)
    "help.seller.overview.title": "Bienvenido al Centro de Ayuda para Vendedores",
    "help.seller.overview.desc": "Como vendedor, gestionas leads, haces seguimiento de oportunidades de renta y ganas comisiones. Esta guía cubre tus herramientas de CRM, gestión de pipeline de rentas y seguimiento de ingresos.",
    "help.seller.leads.title": "Gestión de Leads",
    "help.seller.leads.desc": "Gestiona y convierte leads en clientes",
    "help.seller.leads.manage.title": "Gestionar tus Leads",
    "help.seller.leads.manage.content": "El CRM de Leads es un tablero kanban que te ayuda a dar seguimiento a clientes potenciales a través del pipeline de ventas. Los leads progresan por etapas: Nuevo, Contactado, Calificado, Propuesta, Negociación y Ganado/Perdido. Arrastra y suelta leads entre etapas, agrega notas, programa seguimientos y monitorea tasas de conversión.",
    "help.seller.leads.manage.step1": "Accede a 'CRM - Leads' desde el menú",
    "help.seller.leads.manage.step2": "Revisa los nuevos leads y haz el primer contacto",
    "help.seller.leads.manage.step3": "Mueve los leads a través del pipeline según progresen",
    "help.seller.leads.convert.title": "Convertir Leads en Clientes",
    "help.seller.leads.convert.content": "Cuando un lead firma un contrato de renta, se convierte en cliente y genera una comisión para ti. Monitorea métricas de conversión, identifica estrategias exitosas y optimiza tu proceso de ventas.",
    "help.seller.rentals.title": "Pipeline de Rentas",
    "help.seller.rentals.desc": "Da seguimiento a oportunidades de renta desde el interés hasta la firma del contrato",
    "help.seller.rentals.kanban.title": "Usar el Kanban de Rentas",
    "help.seller.rentals.kanban.content": "El Kanban de Rentas muestra el ciclo de vida completo de cada oportunidad: Interés, Visita Programada, Visitado, Propuesta, Negociación, Apartado, Documentos, Contrato Firmado, Check-in. Cada etapa representa un hito en el proceso de renta. Actualiza los estados en tiempo real según avanzan los deals.",
    "help.seller.rentals.process.title": "Flujo del Proceso de Renta",
    "help.seller.rentals.process.content": "Guía a los clientes a través de cada etapa: programa visitas a propiedades, prepara propuestas, negocia términos, recauda apartados, reúne documentos requeridos, coordina la firma del contrato y programa el check-in. La plataforma registra todas las comunicaciones, documentos y acciones para una auditoría completa.",
    "help.seller.income.title": "Seguimiento de Ingresos",
    "help.seller.income.desc": "Ve tus ganancias y desglose de comisiones",
    "help.seller.income.view.title": "Ver tus Ingresos",
    "help.seller.income.view.content": "Accede a 'Mis Ingresos' para ver tus ganancias totales, comisiones pendientes e historial de pagos. Los ingresos se vuelven visibles cuando los contratos alcanzan el estado 'Apartado', pero el pago se libera solo en el check-in del inquilino.",
    "help.seller.income.commissions.title": "Estructura de Comisiones",
    "help.seller.income.commissions.content": "Las tasas de comisión varían según la duración del contrato: 5+ años = 3 meses de renta, 4 años = 2.5 meses, 3 años = 2 meses, 2 años = 1.5 meses, 1 año = 1 mes, 6 meses = 0.5 meses, Menos de 6 meses = 15% del total. Las comisiones se dividen entre vendedor, HomesApp y socios de referidos.",
    ...
    "sidebar.myApplications": "Mis Solicitudes",
    ...
    "sidebar.externalPublicationRequests": "Solicitudes de Publicación",
    "sidebar.featuredProperties": "Propiedades Destacadas",
    ...
    "sidebar.externalLeadsGlobal": "Leads Globales",
    "sidebar.externalAccounts": "Cuentas",
    "sidebar.externalSellersManagement": "Gestión Vendedores",
    "sidebar.externalPortal": "Portal",
    "sidebar.externalAccesses": "Accesos",
    "sidebar.externalCondominiums": "Propiedades",
    "sidebar.externalReferralNetwork": "Red de Referidos",
    "sidebar.externalContracts": "Contratos",
    "sidebar.externalRentals": "Rentas",
    "sidebar.externalAccounting": "Contabilidad",
    "sidebar.externalPayments": "Cobros",
    "sidebar.externalMaintenance": "Servicios",
    "sidebar.externalQuotations": "Cotizaciones",
    ...
    "sidebar.externalMessages": "Mensajes",
    "sidebar.externalUsers": "Usuarios",
    "sidebar.externalRecruitment": "Reclutamiento",
    "sidebar.externalLeads": "Mis Leads",
    "sidebar.sellerReports": "Mis Reportes",
    "sidebar.sellerCommissions": "Mis Comisiones",
    
    // Seller Commissions Page
    "seller.commissions.title": "Mis Comisiones",
    "seller.commissions.subtitle": "Gestiona tus comisiones y solicita anticipos",
    "seller.commissions.requestAdvance": "Solicitar Anticipo",
    "seller.commissions.requestAdvanceDescription": "Solicita un anticipo de tus comisiones pendientes",
    "seller.commissions.amount": "Monto",
    "seller.commissions.reason": "Motivo",
    "seller.commissions.reasonPlaceholder": "Explica el motivo de tu solicitud de anticipo...",
    "seller.commissions.totalAdvances": "Total Anticipos",
    "seller.commissions.pendingRequests": "Solicitudes Pendientes",
    "seller.commissions.totalRequests": "Total Solicitudes",
    "seller.commissions.advanceHistory": "Historial de Anticipos",
    "seller.commissions.advanceHistoryDescription": "Revisa el estado de tus solicitudes de anticipo",
    "seller.commissions.noAdvances": "No tienes solicitudes de anticipo",
    "seller.commissions.advanceRequested": "Solicitud de anticipo enviada",
    "seller.commissions.adminNotes": "Notas del Admin",
    "seller.commissions.status.pending": "Pendiente",
    "seller.commissions.status.approved": "Aprobado",
    ...
    "configuration.termsAndConditions": "Términos y Condiciones",
    "configuration.tenantTerms": "Términos para Inquilinos",
    "configuration.ownerTerms": "Términos para Propietarios",
    "configuration.version": "Versión",
    "configuration.title.field": "Título",
    "configuration.content": "Contenido",
    "configuration.isActive": "Activo",
    "configuration.publishedAt": "Publicado el",
    "configuration.save": "Guardar Términos",
    "configuration.publish": "Publicar",
    "configuration.unpublish": "Despublicar",
    "configuration.noTerms": "No hay términos y condiciones",
    "configuration.noTermsDesc": "Crea los términos y condiciones que se mostrarán a los inquilinos o propietarios antes de enviar los formularios.",
    "configuration.createTerms": "Crear Términos",
    "configuration.editTerms": "Editar Términos",
    "configuration.saved": "Términos guardados",
    "configuration.savedDesc": "Los términos y condiciones han sido guardados exitosamente",
    "configuration.saveError": "Error al guardar",
    "configuration.published": "Términos publicados",
    "configuration.publishedDesc": "Los términos y condiciones están ahora activos",
    "configuration.unpublished": "Términos despublicados",
    "configuration.unpublishedDesc": "Los términos y condiciones han sido desactivados",
    "configuration.contentPlaceholder": "Escribe los términos y condiciones aquí...",
    "configuration.versionPlaceholder": "ej: 1.0, 1.1, 2.0",
    "configuration.titlePlaceholder": "ej: Términos y Condiciones de Renta",
  ...
  en: {
    ...
    "public.map.title": "Explore on the Map",
    "public.map.subtitle": "Find properties by location in Tulum",
    ...
    "profile.securityDesc": "Manage your password",
    "profile.changePassword": "Change Password",
    "profile.currentPassword": "Current Password",
    "profile.newPassword": "New Password",
    "profile.confirmNewPassword": "Confirm New Password",
    "profile.passwordRequirements": "Password must be at least 8 characters, including uppercase, lowercase and numbers",
    "profile.updatePassword": "Update Password",
    "profile.updatingPassword": "Updating...",
    "profile.passwordUpdated": "Password updated",
    "profile.passwordUpdatedDesc": "Your password has been changed successfully",
    ...
    "property.maxCompareReached": "Max reached",
    "property.maxCompareDescription": "You can only compare up to 4 properties",
    ...
    "sidebar.externalPublicationRequests": "Publication Requests",
    "sidebar.featuredProperties": "Featured Properties",
    ...
    "sidebar.externalDashboard": "Dashboard",
    "sidebar.externalLeadsGlobal": "Global Leads",
    "sidebar.externalAccounts": "Accounts",
    "sidebar.externalSellersManagement": "Sellers Management",
    "sidebar.externalPortal": "Portal",
    "sidebar.externalAccesses": "Accesses",
    "sidebar.externalCondominiums": "Properties",
    "sidebar.externalReferralNetwork": "Referral Network",
    "sidebar.externalContracts": "Contracts",
    "sidebar.externalRentals": "Rentals",
    "sidebar.externalAccounting": "Accounting",
    "sidebar.externalPayments": "Payments",
    "sidebar.externalMaintenance": "Services",
    "sidebar.externalQuotations": "Quotations",
    ...
    "sidebar.externalMessages": "Messages",
    "sidebar.externalUsers": "Users",
    "sidebar.externalRecruitment": "Recruitment",
    "sidebar.externalLeads": "My Leads",
    "sidebar.sellerReports": "My Reports",
    "sidebar.sellerCommissions": "My Commissions",
    
    // Seller Commissions Page
    "seller.commissions.title": "My Commissions",
    "seller.commissions.subtitle": "Manage your commissions and request advances",
    "seller.commissions.requestAdvance": "Request Advance",
    "seller.commissions.requestAdvanceDescription": "Request an advance on your pending commissions",
    "seller.commissions.amount": "Amount",
    "seller.commissions.reason": "Reason",
    "seller.commissions.reasonPlaceholder": "Explain the reason for your advance request...",
    "seller.commissions.totalAdvances": "Total Advances",
    "seller.commissions.pendingRequests": "Pending Requests",
    "seller.commissions.totalRequests": "Total Requests",
    "seller.commissions.advanceHistory": "Advance History",
    "seller.commissions.advanceHistoryDescription": "Review the status of your advance requests",
    "seller.commissions.noAdvances": "You have no advance requests",
    "seller.commissions.advanceRequested": "Advance request submitted",
    "seller.commissions.adminNotes": "Admin Notes",
    "seller.commissions.status.pending": "Pending",
    ...
    "configuration.subtitle": "Manage external system configuration",
    "configuration.termsAndConditions": "Terms and Conditions",
    "configuration.tenantTerms": "Tenant Terms",
    "configuration.ownerTerms": "Owner Terms",
    "configuration.version": "Version",
    "configuration.title.field": "Title",
    "configuration.content": "Content",
    "configuration.isActive": "Active",
    "configuration.publishedAt": "Published on",
    "configuration.save": "Save Terms",
    "configuration.publish": "Publish",
    "configuration.unpublish": "Unpublish",
    "configuration.noTerms": "No terms and conditions",
    "configuration.noTermsDesc": "Create terms and conditions to be displayed to tenants or owners before submitting forms.",
    "configuration.createTerms": "Create Terms",
    "configuration.editTerms": "Edit Terms",
    "configuration.saved": "Terms saved",
    "configuration.savedDesc": "Terms and conditions have been saved successfully",
    "configuration.saveError": "Save error",
    "configuration.published": "Terms published",
    "configuration.publishedDesc": "Terms and conditions are now active",
    "configuration.unpublished": "Terms unpublished",
    "configuration.unpublishedDesc": "Terms and conditions have been deactivated",
    "configuration.contentPlaceholder": "Write terms and conditions here...",
    "configuration.versionPlaceholder": "e.g.: 1.0, 1.1, 2.0",
    "configuration.titlePlaceholder": "e.g.: Rental Terms and Conditions",
