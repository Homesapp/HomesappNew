...
const STATUS_COLORS: Record<string, string> = {
  ...
  oferta_enviada: "bg-cyan-100 text-cyan-700 dark:bg-cyan-900/50 dark:text-cyan-300",
  proceso_de_renta: "bg-indigo-100 text-indigo-700 dark:bg-indigo-900/50 dark:text-indigo-300",
