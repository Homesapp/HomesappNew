  ...
  return (
    ...
    >
      <div
        ...
        className="absolute -left-5 top-1/2 -translate-y-1/2 hidden group-hover/menu-item:block focus-visible:block cursor-grab active:cursor-grabbing p-1 hover-elevate active-elevate-2 rounded-md z-10 focus-visible:ring-2 focus-visible:ring-primary"
  ...
  return (
    ...
    >
      <div
        ...
        tabIndex={0}
        aria-label={`Drag to reorder ${item.titleKey}`}
        className="absolute -left-5 top-1/2 -translate-y-1/2 hidden group-hover/menu-sub-item:block focus-visible:block cursor-grab active:cursor-grabbing p-1 hover-elevate active-elevate-2 rounded-md z-10 focus-visible:ring-2 focus-visible:ring-primary"
        data-testid={`drag-handle-${item.titleKey}`}
      >
        <GripVertical className="w-4 h-4 text-muted-foreground" />
      </div>
